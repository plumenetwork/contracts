...
contract PlumeStaking is SolidStateDiamondProxy{
    ...
    function initializePlume(
        ...
        // Although SolidStateDiamondProxyconstructor sets owner, allow transferring if needed.
        ...
        if (initialOwner != address(0) && initialOwner != owner()) {
            ...
            // Note: SolidStateDiamondProxyinherits SafeOwnable -> Ownable -> OwnableInternal
