...
/**
 * @title PlumenYieldStaking
 * @author Eugene Y. Q. Shen, Alp Guneysel
 * @notice Proxy contract for nYIELD Staking
 */
contract PlumenYieldStaking is ERC1967Proxy {
    ...
    bytes32 public constant PROXY_NAME = keccak256("PlumenYieldStaking");
