...
contract ArbNativeOFTAdapterUpgradeableTest is TestHelperOz5 {
    ...
    function test_send_with_enough_native() public {
        ...
        // Set total amount with dust and expected amount post dust removal
    ...
    function test_send_from_main_to_other_chain_using_upgradeable_adapter() public {
        ...
        // First send: Alice sends native token from adapter → remoteOFT
        SendParam memory sendParam = SendParam(
            eid_b,
            addressToBytes32(alice),
            totalAmount,
        ...
        // Second send: Alice sends remoteOFT back to adapter → Bob receives native
    ...
    function test_send_reverts_when_value_gt_fee_and_sender_balance_gt_send_amount() public {
        ...
        uint256 overpaidMsgValue = 3 ether;
        ...
        vm.prank(alice);
        adapter.send{ value: overpaidMsgValue }(sendParam, fee, alice);
    }
